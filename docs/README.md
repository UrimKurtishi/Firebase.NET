...
2. PushnotificationService("yourFcmServcrKey")
	This constructor takes your Firebase server key and it's ready to push notifications.
3. **PushnotificationService("yourFcmServcrKey", updateFunc, deleteFunc)**
...
4. PushnotificationService(updateFunc, deleteFunc)
...
5. PushnotificationService(updateFunc, deleteFunc, appSettings)
...
6. PushnotificationService(appSettings)
